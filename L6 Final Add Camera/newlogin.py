...
class LoginApp(tk.Tk):
    ...
    def on_login(self):
        ...
        if response.status_code == 200 and response_data['status'] == 'success':
            #scores = {score['id']: score['title'] for score in response_data.get('scores', [])}
...
class ServerApp(tk.Tk):
    ...
    def start_server(self):
        ...
        # Run newmain.py with these as parameters
    ...
    def run_newmain_script(self, score_id, score_title, score_user_id):
        # Using subprocess to run the newmain.py script with parameters
        subprocess.Popen(["python3", "/Users/mlab/work/new3camera/newmain.py", str(score_id), score_title, str(score_user_id)])
...
class ScoreSelectWindow(Toplevel):
    ...
    def select_score(self):
        ...
        if selected_index:
            ...
            # Updating the parent (ServerApp) directly.
